...
module.exports = React.createClass({
	...
	getInitialState () {
		return {
			...
			pageLanguage: Language.getApplicationLanguages('guideStep2Page'),
	...
	nextStep () {
		var self = this;
		self.transitionTo('tabs:guide-step-3', { transition: 'show-from-left' });
	},
			...
			<div className="guide-background">
				...
				<div className="guide-body">
					<div className="content-image-capture">
						<div className="image-capture">
							<img src="img/check.png" className="guide-body-image-step-1" />
						</div>	
					</div>
				...
				<div className="guide-footer">
					<div className="div-bottom-button">
						...
						<div className="span-active central-button"></div>
						<div className="span-inactive"></div>
					</div>
