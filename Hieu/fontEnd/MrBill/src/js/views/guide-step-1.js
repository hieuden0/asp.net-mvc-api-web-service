...
module.exports = React.createClass({
	...
	getInitialState () {
		return {
			...
			pageLanguage: Language.getApplicationLanguages('guideStep1Page'),
	...
	nextStep () {
		var self = this;
		self.transitionTo('tabs:guide-step-2', { transition: 'show-from-left' });
	},
				...
				<div className="guide-body">
					<div className="content-image-capture">
						<div className="image-capture">
							<img src="img/capture.png" className="guide-body-image-step-1" />
						</div>	
					</div>		
